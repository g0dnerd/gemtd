...
export const WAVES: WaveDef[] = [
  ...
  w(6, "normal", 17, 500, 2, 0.55, 12),
  w(7, "fast", 19, 400, 2, 0.45, 12),
  w(8, "air", 12, 330, 2, 0.6, 14),
  w(9, "armored", 13, 1000, 3, 0.85, 17, 0, 13),
  w(10, "boss", 4, 3000, 5, 1.2, 30),

  // --- Waves 11-19: healers introduced, light mixing, armor ramp begins ---
  wm(11, 0.55, 9, ["healer", 2, 1000, 4], ["normal", 15, 2450, 2, 0, 1]),
  w(12, "fast", 20, 2410, 2, 0.4, 9, 0, 1),
  wm(
    13,
    0.75,
    12,
    ...
    groups: [
      {
        ...
        slowResist: 0,
        payload: [
          { kind: "normal" as CreepKind, count: 10, hp: 1200, bounty: 2 },
        ],
      },
    ],
    interval: 2.5,
  ...
  w(16, "fast", 22, 4040, 3, 0.4, 12, 0, 2),
  wm(
    17,
    0.55,
    14,
    ["normal", 13, 4980, 3, 0, 2],
    ["fast", 6, 4980, 3, 0, 2],
    ["healer", 2, 3300, 5],
  ),
  ...
  wm(
    ...
    18,
    ["air", 7, 11580, 3, 0.1],
    ["fast", 10, 11580, 3, 0.1, 3],
    ["tunneler", 4, 8000, 5, 0.1, 3],
  ),
  {
    number: 25,
    groups: [
        ...
        payload: [
          {
            ...
            bounty: 4,
            payload: [
              { kind: "fast" as CreepKind, count: 5, hp: 12000, bounty: 2 },
            ],
          },
        ],
      },
  ...
  wm(
    ...
    0.35,
    21,
    ["fast", 19, 12350, 2, 0.22, 3],
    ["tunneler", 8, 13000, 4, 0.22, 3],
  ),
  wm(
    27,
    0.75,
    23,
    ["armored", 13, 15980, 3, 0.04, 18],
    ["fast", 4, 15980, 3, 0.04, 3],
    ["healer", 2, 11000, 4, 0.04, 3],
  ),
  w(28, "normal", 18, 24824, 3, 0.5, 24, 0.16, 4),
  wm(
    29,
    0.5,
    25,
    ["armored", 7, 21900, 2, 0.18, 15],
    ["fast", 12, 21900, 2, 0.18, 4],
    ["healer", 2, 15300, 4, 0.18, 4],
  ),
  wm(30, 1.0, 80, ["boss", 8, 32000, 13, 0, 5], ["healer", 2, 15400, 8, 0, 3]),
  ...
  wm(
    ...
    0.5,
    23,
    ["chrysalid", 22, 14000, 4, 0.22, 7],
    ["healer", 3, 12400, 5, 0.22, 7],
  ),
  wm(
    32,
    0.35,
    24,
    ["fast", 15, 21600, 4, 0.34, 8],
    ["chrysalid", 12, 22200, 4, 0.34, 8],
  ),
  w(33, "armored", 18, 31600, 4, 0.75, 27, 0.06, 38),
  wm(
    34,
    0.55,
    27,
    ["chrysalid", 17, 28800, 4, 0.28, 9],
  ),
  {
    number: 35,
    groups: [
  ...
  wm(
    ...
    0.5,
    24,
    ["armored", 12, 25270, 3, 0.3, 28],
    ["chrysalid", 10, 17700, 3, 0.3, 9],
    ["healer", 3, 17700, 4, 0.3, 9],
  ),
  wm(
    37,
    0.75,
    26,
    ["armored", 14, 31840, 4, 0.24, 33],
    ["chrysalid", 5, 22300, 4, 0.24, 11],
    ["healer", 3, 22300, 5, 0.24, 11],
  ),
  wm(
    38,
    0.5,
    27,
    ["air", 7, 27500, 4, 0.36, 8],
    ["chrysalid", 6, 20800, 4, 0.36, 11],
    ["tunneler", 3, 20800, 4, 0.36, 11],
  ),
  wm(
    39,
    0.5,
    30,
    ["fast", 12, 43200, 3, 0.38, 12],
    ["chrysalid", 8, 30200, 3, 0.38, 12],
    ["tunneler", 4, 30200, 4, 0.38, 12],
  ),
  wm(
    40,
    1.0,
    80,
    ["boss", 9, 54000, 18, 0, 14],
    ["healer", 4, 24000, 13, 0, 11],
  ),
  ...
  wm(
    ...
    0.5,
    25,
    ["chrysalid", 20, 24000, 3, 0.42, 14],
    ["tunneler", 2, 21000, 4, 0.42, 14],
    ["healer", 5, 21000, 5, 0.42, 14],
  ),
  wm(
    42,
    0.35,
    26,
    ["fast", 24, 39500, 3, 0.54, 15],
    ["chrysalid", 4, 27100, 4, 0.54, 15],
  ),
  w(43, "armored", 20, 43000, 4, 0.75, 28, 0.36, 45),
  wm(
    44,
    0.5,
    29,
    ["armored", 14, 33000, 3, 0.5, 30],
    ["tunneler", 5, 33000, 4, 0.5, 17],
    ["healer", 3, 33000, 6, 0.5, 17],
  ),
  {
    number: 45,
    groups: [
  ...
  wm(
    ...
    0.35,
    22,
    ["chrysalid", 20, 45000, 3, 0.62, 17],
    ["tunneler", 3, 37000, 3, 0.62, 17],
    ["healer", 3, 37000, 4, 0.62, 17],
  ),
  wm(
    47,
    0.75,
    23,
    ["armored", 18, 68230, 3, 0.44, 45],
    ["healer", 4, 48000, 4, 0.44, 18],
  ),
  wm(
    48,
    0.5,
    24,
    ["air", 12, 52000, 3, 0.56, 12],
    ["tunneler", 8, 39000, 4, 0.56, 18],
  ),
  wm(
    49,
    0.5,
    26,
    ["chrysalid", 14, 70000, 3, 0.58, 19],
    ["tunneler", 6, 80000, 4, 0.58, 19],
    ["healer", 4, 60000, 4, 0.58, 19],
  ),
  {
    number: 50,
    groups: [
