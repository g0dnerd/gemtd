...
export const WAVES: WaveDef[] = [
  ...
  wm(
    ...
    ["tunneler", 6, 7400, 3, 0.02, 3],
  ),
  wm(
    22,
    0.35,
    17,
    ["fast", 13, 11805, 3, 0.14, 3],
    ["armored", 10, 7870, 3, 0.14],
  ...
  wm(
    ...
    0.75,
    23,
    ["armored", 11, 15980, 3, 0.04, 18],
    ["fast", 6, 15980, 3, 0.04, 3],
  ...
  wm(
    ...
    ["healer", 3, 12400, 2, 0.22, 7],
  ),
  wm(
    32,
    0.35,
    13,
    ["fast", 15, 21600, 2, 0.34, 8],
  ...
  wm(
    ...
    0.5,
    13,
    ["armored", 12, 25270, 2, 0.3, 28],
    ["chrysalid", 10, 23895, 2, 0.3, 11],
    ["healer", 3, 17700, 2, 0.3, 9],
  ),
  wm(
    37,
    0.75,
    14,
    ["armored", 14, 31840, 2, 0.24, 33],
    ["chrysalid", 5, 22300, 2, 0.24, 11],
    ["healer", 3, 22300, 2, 0.24, 11],
  ),
  wm(
    38,
    0.5,
    14,
    ["air", 7, 27500, 2, 0.36, 8],
    ["chrysalid", 6, 20800, 2, 0.36, 11],
    ["tunneler", 3, 20800, 2, 0.36, 11],
  ),
  wm(
    39,
    0.5,
    15,
    ["fast", 12, 43200, 2, 0.38, 12],
    ["chrysalid", 8, 30200, 2, 0.38, 12],
    ["tunneler", 4, 30200, 2, 0.38, 12],
  ),
  wm(
    40,
    1.0,
  ...
  wm(
    ...
    0.35,
    17,
    ["fast", 24, 39500, 2, 0.54, 15],
    ["chrysalid", 4, 27100, 2, 0.54, 15],
  ),
  w(43, "armored", 20, 43000, 2, 0.75, 18, 0.36, 45),
  wm(
    44,
    0.5,
    18,
    ["armored", 14, 46200, 2, 0.5, 30],
    ["tunneler", 5, 33000, 2, 0.5, 17],
    ["healer", 3, 33000, 2, 0.5, 17],
  ),
  {
    number: 45,
    groups: [
  ...
  wm(
    ...
    0.35,
    17,
    ["chrysalid", 15, 49500, 2, 0.62, 22],
    ["tunneler", 8, 40700, 2, 0.62, 22],
    ["healer", 3, 40700, 2, 0.62, 17],
  ),
  wm(
    47,
    0.75,
    18,
    ["armored", 18, 68230, 2, 0.44, 45],
    ["healer", 4, 48000, 2, 0.44, 27],
  ),
  wm(
    48,
    0.5,
    18,
    ["air", 12, 41600, 2, 0.56, 12],
    ["tunneler", 8, 39000, 2, 0.56, 18],
  ),
  wm(
    49,
    0.5,
    19,
    ["chrysalid", 14, 70000, 2, 0.58, 19],
    ["tunneler", 6, 80000, 2, 0.58, 19],
    ["healer", 4, 60000, 2, 0.58, 19],
  ),
  {
    number: 50,
    groups: [
