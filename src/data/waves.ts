...
export const WAVES: WaveDef[] = [
  ...
  wm(
    ...
    18,
    ["carapace", 14, 10830, 4],
    ["shambler", 3, 10830, 4, 0, 3],
    ["burrower", 2, 7500, 6, 0, 3],
  ),
  wm(
    24,
    0.5,
  ...
  w(28, "shambler", 18, 24824, 3, 0.5, 24, 0.16, 4),
  wm(
    29,
    0.5,
    25,
  ...
  wm(
    ...
    0.35,
    13,
    ["skitter", 15, 21600, 2, 0.34, 8],
    ["chrysalid", 12, 22200, 2, 0.34, 8],
  ),
  w(33, "carapace", 18, 28440, 2, 0.75, 14, 0.06, 38),
  ...
  wm(
    ...
    0.75,
    14,
    ["carapace", 14, 31840, 2, 0.24, 33],
    ["chrysalid", 5, 22300, 2, 0.24, 11],
    ["mender", 3, 22300, 2, 0.24, 11],
  ),
  wm(
    38,
    0.5,
  ...
  wm(
    ...
    0.5,
    15,
    ["skitter", 12, 43200, 2, 0.38, 12],
    ["chrysalid", 8, 30200, 2, 0.38, 12],
    ["burrower", 4, 30200, 2, 0.38, 12],
  ),
  wm(
    40,
    1.0,
  ...
  wm(
    ...
    0.35,
    17,
    ["skitter", 24, 39500, 2, 0.54, 15],
    ["chrysalid", 4, 27100, 2, 0.54, 15],
  ),
  w(43, "carapace", 20, 43000, 2, 0.75, 18, 0.36, 45),
  wm(
    44,
    0.5,
    18,
  ...
  wm(
    ...
    ["burrower", 8, 40700, 2, 0.62, 22],
    ["mender", 3, 40700, 2, 0.62, 17],
  ),
  wm(
    47,
    0.75,
    18,
    ["carapace", 18, 60040, 2, 0.44, 45],
    ["mender", 4, 42240, 2, 0.44, 27],
  ),
  wm(
    48,
    0.5,
