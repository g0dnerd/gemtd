...
export const WAVES: WaveDef[] = [
  ...
  wm(
    ...
    ["armored", 3, 18530, 3, 0.18, 15],
    ["fast", 6, 18530, 3, 0.18, 4],
    ["healer", 2, 13000, 5, 0.18, 4],
  ),
  wm(30, 1.0, 80, ["boss", 8, 32000, 18, 0, 5], ["healer", 2, 15400, 12, 0, 3]),
  ...
  wm(
    ...
    0.5,
    23,
    ["normal", 10, 17690, 5, 0.22, 7],
    ["fast", 5, 17690, 5, 0.22, 7],
    ["chrysalid", 6, 12400, 5, 0.22, 7],
  ...
  wm(
    ...
    0.35,
    24,
    ["fast", 16, 18320, 5, 0.34, 8],
    ["air", 4, 18320, 5, 0.34, 5],
    ["chrysalid", 4, 12800, 5, 0.34, 8],
    ["healer", 3, 12800, 7, 0.34, 8],
  ),
  w(33, "armored", 18, 21600, 5, 0.75, 27, 0.06, 21),
  wm(
    34,
    0.55,
    27,
    ["chrysalid", 14, 14000, 5, 0.28, 9],
  ...
  wm(
    ...
    0.5,
    24,
    ["normal", 8, 25270, 4, 0.3, 9],
    ["armored", 4, 25270, 4, 0.3, 22],
    ["fast", 4, 25270, 4, 0.3, 9],
    ["chrysalid", 6, 17700, 4, 0.3, 9],
    ["healer", 3, 17700, 6, 0.3, 9],
  ),
  wm(
    37,
    0.75,
    26,
    ["armored", 11, 31840, 5, 0.24, 26],
    ["chrysalid", 5, 22300, 5, 0.24, 11],
    ["tunneler", 3, 22300, 7, 0.24, 11],
    ["healer", 2, 22300, 7, 0.24, 11],
  ),
  wm(
    38,
    0.5,
    27,
    ["air", 7, 22000, 5, 0.36, 8],
    ["chrysalid", 6, 16600, 5, 0.36, 11],
    ["healer", 3, 16600, 7, 0.36, 11],
  ),
  wm(
    39,
    0.5,
    30,
    ["normal", 8, 36640, 4, 0.38, 12],
    ["fast", 5, 36640, 4, 0.38, 12],
    ["armored", 3, 36640, 4, 0.38, 27],
    ["chrysalid", 5, 25600, 4, 0.38, 12],
    ["tunneler", 3, 25600, 6, 0.38, 12],
  ),
  wm(
    40,
    1.0,
    80,
    ["boss", 9, 50400, 26, 0, 14],
    ["healer", 4, 24000, 19, 0, 11],
  ),
  ...
  wm(
    ...
    0.5,
    25,
    ["normal", 14, 30330, 4, 0.42, 14],
    ["chrysalid", 5, 21000, 4, 0.42, 14],
    ["mycoid", 2, 21000, 5, 0.42, 14],
    ["healer", 4, 21000, 7, 0.42, 14],
    ["tunneler", 2, 21000, 7, 0.42, 14],
  ),
  wm(
    42,
    0.35,
    26,
    ["fast", 18, 33490, 4, 0.54, 15],
    ["chrysalid", 5, 23000, 4, 0.54, 15],
    ["mycoid", 2, 23000, 5, 0.54, 15],
    ["tunneler", 4, 23000, 7, 0.54, 15],
    ["healer", 2, 23000, 7, 0.54, 15],
  ),
  wm(
    43,
    0.75,
    28,
    ["armored", 14, 43220, 6, 0.36, 31],
    ["chrysalid", 4, 30000, 4, 0.36, 15],
    ["mycoid", 2, 30000, 6, 0.36, 15],
    ["healer", 3, 30000, 8, 0.36, 15],
    ["tunneler", 2, 30000, 8, 0.36, 15],
  ),
  wm(
    44,
    0.5,
    29,
    ["chrysalid", 12, 33000, 4, 0.5, 17],
    ["mycoid", 3, 33000, 5, 0.5, 17],
    ["healer", 3, 33000, 8, 0.5, 17],
    ["tunneler", 2, 33000, 8, 0.5, 17],
  ),
  {
    number: 45,
    groups: [
  ...
  wm(
    ...
    0.35,
    22,
    ["fast", 18, 53070, 4, 0.62, 17],
    ["chrysalid", 6, 37000, 4, 0.62, 17],
    ["mycoid", 2, 37000, 4, 0.62, 17],
    ["tunneler", 2, 37000, 6, 0.62, 17],
    ["healer", 2, 37000, 6, 0.62, 17],
  ),
  wm(
    47,
    0.75,
    23,
    ["armored", 14, 68230, 4, 0.44, 36],
    ["chrysalid", 4, 48000, 4, 0.44, 18],
    ["mycoid", 2, 48000, 4, 0.44, 18],
    ["healer", 3, 48000, 6, 0.44, 18],
    ["tunneler", 2, 48000, 6, 0.44, 18],
  ),
  wm(
    48,
    0.5,
    24,
    ["air", 10, 52000, 4, 0.56, 12],
    ["chrysalid", 4, 39000, 4, 0.56, 18],
    ["mycoid", 2, 39000, 4, 0.56, 18],
    ["tunneler", 2, 39000, 6, 0.56, 18],
    ["healer", 3, 39000, 6, 0.56, 18],
  ),
  wm(
    49,
    0.5,
    26,
    ["chrysalid", 8, 53000, 4, 0.58, 19],
    ["normal", 8, 75820, 4, 0.58, 19],
    ["mycoid", 3, 53000, 4, 0.58, 19],
    ["healer", 4, 53000, 6, 0.58, 19],
    ["tunneler", 4, 53000, 6, 0.58, 19],
  ),
  {
    number: 50,
    groups: [
