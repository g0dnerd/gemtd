...
const ALL_COMBOS: ComboRecipe[] = [
  ...
  },
  {
    ...
    stats: {
      ...
      range: 3.5,
      atkSpeed: 1.2,
      effects: [{ kind: "eruption", threshold: 8, damage: 1200, radius: 2.5, falloff: 0.4 }],
      blurb: "Eruption every 8 hits: 1200 AoE in r=2.5.",
      targeting: "all",
    },
    upgrades: [
      {
        ...
        stats: {
          ...
          atkSpeed: 1.3,
          effects: [
            { kind: "eruption", threshold: 6, damage: 1800, radius: 3.0, falloff: 0.35, afterburnDps: 100, afterburnDuration: 3 },
          ],
          blurb: "Eruption every 6 hits: 1800 AoE r=3.0. Afterburn 100/s 3s.",
          targeting: "all",
        },
      },
    ],
    ...
    upgrades: [
      ...
      },
      {
        ...
        stats: {
          ...
          blurb:
            "Poison 110 dps 4s. 50% slow. Lucky crits, stuns, and bonus gold.",
          targeting: "all",
        },
      },
    ],
      ...
      },
      {
        ...
        stats: {
          ...
          effects: [
            ...
            { kind: "death_nova", hpPct: 0.08, radius: 1.0 },
          ],
  ...
  },
  {
    ...
    stats: {
      ...
      blurb: "Burns enemies for 85/s and slows 45% within range.",
      targeting: "all",
    },
    upgrades: [
      {
  ...
  },
  {
    ...
    stats: {
      ...
      blurb: "All gem powers combined. Splash, crit, poison, slow, stun, ramping beam.",
      targeting: "all",
    },
    upgrades: [],
    visualGem: "diamond",
