    ...
    upgrades: [
      {
        ...
        stats: {
          ...
          blurb:
            "100% splash. Stacking armor shred -3/hit (max 6). Proximity slow.",
          targeting: "all",
        },
      },
    ],
    ...
    upgrades: [
      {
        ...
        stats: {
          ...
          blurb: "18% crit x2.5. Crit splashes. -8 armor to ground.",
          targeting: "all",
        },
      },
    ],
        ...
        stats: {
          ...
          effects: [
            ...
            },
            {
              ...
              dmgBonus: 0.35,
              hpThreshold: 0.25,
              onKillShredRadius: 2.5,
              onKillShredValue: 8,
              onKillShredDuration: 5,
            },
          ],
          blurb:
            "Adaptive master. Execute in focus mode; execute-kills shred armor (-8) of nearby creeps for 5s.",
          targeting: "all",
        },
      },
    ],
    ...
    upgrades: [
      {
        ...
        stats: {
          ...
          atkSpeed: 0.72,
          effects: [
            { kind: "demote_air", everyN: 9 },
            { kind: "true_vs_air" },
          ],
          blurb: "True damage vs air. Every 9th hit grounds air units.",
          targeting: "all",
        },
      },
      {
        ...
        stats: {
          ...
          atkSpeed: 0.72,
          effects: [
            { kind: "demote_air", everyN: 8 },
            { kind: "true_vs_air" },
          ],
          blurb: "True damage vs air. Every 8th hit grounds air units.",
          targeting: "all",
        },
      },
    ],
      ...
      },
      {
        ...
        stats: {
          ...
          effects: [
            ...
            { kind: "periodic_nova", everyN: 11 },
          ],
          blurb: "Wide splash. 55% slow. Nova every 11th attack at 50% dmg.",
          targeting: "all",
        },
      },
    ],
