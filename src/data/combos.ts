    ...
    upgrades: [
      ...
      },
      {
        ...
        stats: {
          ...
          range: 4.0,
          atkSpeed: 1.6,
          effects: [{ kind: "chain", bounces: 9, falloff: 0.85 }],
