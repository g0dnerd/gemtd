    ...
    upgrades: [
      {
        ...
        stats: {
          ...
          range: 4.5,
          atkSpeed: 1.0,
          effects: [{ kind: "aura_dmg", radius: 4.5, pct: 0.4 }],
          blurb: "+40% dmg aura. Wider radius.",
          targeting: "all",
        },
      },
    ],
    ...
    upgrades: [
      {
        ...
        stats: {
          ...
          atkSpeed: 1.1,
          effects: [
            { kind: "crit", chance: 0.3, multiplier: 3.5 },
            { kind: "armor_reduce", value: 8, duration: 5 },
          ],
          blurb: "30% crit x3.5. -8 armor on hit for 5s.",
          targeting: "all",
        },
      },
    ],
    ...
    upgrades: [
      {
        ...
        stats: {
          ...
          range: 3.75,
          atkSpeed: 1.0,
          effects: [{ kind: "prox_burn", dps: 42, radius: 3.75 }],
          blurb: "Burns all enemies within range for 42/s.",
          targeting: "all",
        },
      },
      {
        ...
        stats: {
          ...
          range: 4.0,
          atkSpeed: 1.0,
          effects: [{ kind: "prox_burn", dps: 85, radius: 4.0 }],
          blurb: "Burns all enemies within range for 85/s.",
          targeting: "all",
        },
      },
    ],
    ...
    upgrades: [
      {
        ...
        stats: {
          ...
          atkSpeed: 1.0,
          effects: [
            { kind: "prox_burn", dps: 260, radius: 4.75 },
            { kind: "prox_slow", factor: 0.5, radius: 4.75 },
          ],
          blurb: "Burns enemies for 260/s and slows 50% within range.",
          targeting: "all",
        },
      },
    ],
