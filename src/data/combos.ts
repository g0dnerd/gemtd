...
const ALL_COMBOS: ComboRecipe[] = [
    ...
    upgrades: [
      {
        ...
        stats: {
          ...
          effects: [
            ...
            { kind: "vulnerability_aura", radius: 4.5, pct: 0.20 },
          ],
    ...
    upgrades: [
      {
        ...
        stats: {
          ...
          effects: [
            ...
            { kind: "stun_poison", dps: 80, duration: 3 },
            { kind: "death_spread", count: 2, radius: 2.0 },
          ],
          blurb: "15% stun + poison. Plague spreads on death.",
          targeting: "all",
        },
      },
    ],
    ...
    upgrades: [
      {
        ...
        stats: {
          ...
          effects: [
            ...
            { kind: "prox_armor_reduce", radius: 4.0, value: 6, targets: "ground" },
          ],
    ...
    upgrades: [
      ...
      },
      {
        ...
        stats: {
          ...
          blurb: "Poison 60 dps 4s. 50% slow. Lucky crits, stuns, and bonus gold.",
          targeting: "all",
        },
      },
    ],
    ...
    upgrades: [
      {
        ...
        stats: {
          ...
          range: 3.75,
          atkSpeed: 1.5,
          effects: [{ kind: "multi_target", count: 4 }],
    ...
    upgrades: [
      {
        ...
        stats: {
          ...
          effects: [
            ...
            { kind: "freeze_chance", chance: 0.10, duration: 0.8 },
          ],
      ...
      },
      {
        ...
        stats: {
          ...
          effects: [
            ...
            { kind: "freeze_chance", chance: 0.20, duration: 1.2 },
            { kind: "periodic_nova", everyN: 4 },
          ],
          blurb: "Wide splash. 45% slow. 20% freeze. Nova every 4th attack.",
          targeting: "all",
        },
      },
    ],
    ...
    upgrades: [
      {
        ...
        stats: {
          ...
          atkSpeed: 1.0,
          effects: [
            { kind: "prox_burn_ramp", dps: 36, radius: 3.75, rampPct: 0.08, rampCap: 0.80 },
          ],
      ...
      },
      {
        ...
        stats: {
          ...
          atkSpeed: 1.0,
          effects: [
            { kind: "prox_burn_ramp", dps: 70, radius: 4.0, rampPct: 0.10, rampCap: 1.20 },
            { kind: "armor_pierce_burn" },
            { kind: "death_nova", hpPct: 0.10, radius: 2.0 },
          ],
          blurb: "Burn ramps +10%/s. Ignores armor. Death nova.",
          targeting: "all",
        },
      },
    ],
    ...
    upgrades: [
      {
        ...
        stats: {
          ...
          effects: [
            ...
            { kind: "frostbite", speedThreshold: 0.40, dmgBonus: 0.25 },
          ],
          blurb: "AoE slow. Periodic freeze. Frostbite: +25% dmg to slowed.",
          targeting: "all",
        },
      },
    ],
    ...
    upgrades: [
      {
        ...
        stats: {
          ...
          atkSpeed: 0.6,
          effects: [
            { kind: "splash", radius: 1.5, falloff: 0.5, chance: 1.0 },
            { kind: "stacking_armor_reduce", perHit: 2, maxStacks: 6, decayInterval: 3 },
            { kind: "prox_slow", factor: 0.85, radius: 4.5 },
          ],
          blurb: "100% splash. Stacking armor shred. Proximity slow.",
          targeting: "all",
        },
      },
    ],
  ...
  },
  {
    ...
    stats: {
      ...
      atkSpeed: 1.0,
      effects: [
        { kind: "prox_burn", dps: 190, radius: 4.5 },
        { kind: "prox_slow", factor: 0.5, radius: 4.5 },
      ],
      blurb: "Burns enemies for 190/s and slows 50% within range.",
      targeting: "all",
    },
    upgrades: [
      {
        ...
        stats: {
          ...
          atkSpeed: 1.0,
          effects: [
            { kind: "prox_burn", dps: 220, radius: 4.75 },
            { kind: "prox_slow", factor: 0.50, radius: 4.75 },
            { kind: "armor_decay_aura", armorPerSec: 1, radius: 4.75 },
            { kind: "linger_burn", duration: 3 },
          ],
