...
const ALL_COMBOS: ComboRecipe[] = [
  ...
  },
  {
    ...
    stats: {
      ...
      range: 4.0,
      atkSpeed: 0.8,
      effects: [{ kind: "adaptive_mode", threshold: 3, scatterCount: 5, scatterDmgMult: 0.6 }],
    ...
    upgrades: [
      {
        ...
        stats: {
          ...
          range: 4.5,
          atkSpeed: 0.9,
          effects: [{ kind: "adaptive_mode", threshold: 3, scatterCount: 6, scatterDmgMult: 0.7 }],
      ...
      },
      {
        ...
        stats: {
          ...
          atkSpeed: 1.0,
          effects: [
            { kind: "adaptive_mode", threshold: 3, scatterCount: 8, scatterDmgMult: 0.85 },
            { kind: "execute", dmgBonus: 0.4, hpThreshold: 0.25 },
          ],
